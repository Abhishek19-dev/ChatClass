 import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Avatar, Box, Button, Divider, Heading, Icon, Text } from '@chakra-ui/react';
        ...
        <Box border='1px solid' borderColor='lightgray' borderRadius='sm'> {/* Add border here */}
          <AccordionButton>
            <Box display='flex' as="span" flex='1' textAlign='left'>
              <Box display='flex'>
                ...
                <Text fontWeight='bold' fontFamily='Public Sans' ml={4}>Personal Info</Text>
              </Box>
            </Box>
            <AccordionIcon />
          </AccordionButton>
          <AccordionPanel bgColor='white' pb={4}>
            <Box  display='flex' flexDirection='column' justifyContent='space-between'>
                ...
                <Button fontFamily='Public Sans' fontWeight={500} leftIcon={<UilEditAlt/>} bg='#EFF2F6' textColor='#3F414D' variant='solid'>
                 Edit
               </Button>
                </Box>
